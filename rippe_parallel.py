...
if __name__ == "__main__":
  ...
  costs_list = list() #list with the costs of all N experiments

  #Running without the optimizer:
  #not_optimize(param_names, fname)

  #Running with the optimizer:
  optimize(param_names, fname)
  test(param_names, fname, object_name)

  #Getting the mean costs and standard deviations by running x times (without optimizer):
  #i = 0
  #while i < 30:
  #    print("Run " + str(i))
  #    not_optimize(param_names,fname)
  ...
  #print("Cost Standard Deviation: " + str(stdev))